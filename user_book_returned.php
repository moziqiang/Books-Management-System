...
<div>
    <table class="table table-hover">
        ...
        <tbody>
        <?php
        $sql = "SELECT book_id,book_name,book_price,book_chuban,book_author,btime,rtime FROM book_info,book_borrow,book_user WHERE book_info.book_id = book_borrow.bid AND book_user.id = book_borrow.uid AND book_borrow.uid = $_SESSION[user_id] AND rtime is not NULL";
        if ($sql){
